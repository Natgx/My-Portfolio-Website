...
// This function changes the slide when the left or right arrow is clicked
...
function showSlides(n) {
    ...
    for (i=0; i < dots.length; i++) {
        dots[i].className = dots[i].className.replace(" active", ""); // This for loop takes each item in the array "dots" and removes "active" whic removes the active styling
    }
...
// The first step is to add event listener for any clicks one the website
